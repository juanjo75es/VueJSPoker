...
export const combinations = (arr:Array<any>, min = 1, max: number) => {
    const combination = (arr: Array<any>, depth: number) => {
      if (depth === 1) {
        return arr;
      } else {
        const result:any = combination(arr, depth - 1).flatMap((val) =>
...
export function straight_flush(hand: Array<string>)
{
...
export function poker(hand: Array<string>)
{
    return there_is_repetition(hand,4)
}

export function full_house(hand: Array<string>)
{
    let mymap=new Map()
    for(let i=0;i<5;i++)
    {
...
export function flush(hand: Array<string>)
{   
    let color=hand[0][0]
    for(let i=1;i<5;i++)
    {
...
export function straight(hand: Array<string>)
{
    //console.log(hand)
...
export function three_of_a_kind(hand: Array<string>)
{
    return there_is_repetition(hand,3)
}

export function two_pair(hand: Array<string>)
{
    let mymap=new Map()
    for(let i=0;i<5;i++)
    {
...
function there_is_repetition(hand: Array<string>,n: number)
{
    let mymap=new Map()
    let max=0
    let maxv=''
...
export function one_pair(hand: Array<string>)
{
    return there_is_repetition(hand,2)
}

export function highest_card(hand1: Array<string>,exclude1: Array<string>,
    hand2: Array<string>,exclude2: Array<string>)
{
    //console.log(hand1)
    let fhand1=[]
    let fhand2=[]
...
function score_hand(hand: Array<string>)
{
    let score:any=straight_flush(hand)
    if(score[0])
    {
...
export function compare_hands(hand1: Array<string>,hand2: Array<string>)
{
...
const getAllSubsets = 
      (theArray:Array<any>) => theArray.reduce(
        (subsets, value) => subsets.concat(
         subsets.map((set:Array<any>) => [value,...set])
        ),
        [[]]
      );
